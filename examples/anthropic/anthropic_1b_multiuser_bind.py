...
USER_TESTS = {
    "alice": {
        ...
        "tests": [
            ...
            ("claude-3-haiku-20240307", 400, True),   # ALLOWED - correct model, within limit
            ("claude-opus-4-5-20251101", 400, False),   # BLOCKED - alice can't use Opus
            ("claude-3-haiku-20240307", 600, False),  # BLOCKED - exceeds max_tokens
        ]
    },
    "bob": {
        "password": "Bob@123!",
        ...
        "tests": [
            ...
            ("claude-3-haiku-20240307", 600, True),   # ALLOWED - within bob's 2000 limit
            ("claude-opus-4-5-20251101", 2500, False),  # BLOCKED - exceeds max_tokens
        ]
    }
}
